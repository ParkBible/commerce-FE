...
const AuthenticatedChatManagementRoute = AuthenticatedChatManagementRouteImport.update({
    id: "/chat-management",
...
const AuthenticatedProductsProductIdEditRoute = AuthenticatedProductsProductIdEditRouteImport.update({
