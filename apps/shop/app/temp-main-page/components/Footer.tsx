...
function Footer() {
  return (
    <footer className="flex flex-col justify-center items-start self-stretch px-40 py-28 bg-black max-w-[1440px]">
      <div className="flex flex-wrap gap-28 justify-between items-start w-full">
        <section className="w-96 min-w-60">
          <h1 className="max-w-full text-2xl font-bold tracking-tight leading-snug text-center text-white w-[135px]">
            801 COFFEE
          </h1>
