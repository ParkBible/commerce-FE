...
const Products: React.FC = () => {
  const products = [
    ...
    },
    {
      ...
      features: [
        { icon: 'https://cdn.builder.io/api/v1/image/assets/TEMP/7ec1fe57569b1f4a69a9d7b05a066a87d07c92fb', value: '80ml' }
      ],
      name: '스페셜 리저브 하와이 코나',
    ...
    },
    {
      ...
      features: [
        { icon: 'https://cdn.builder.io/api/v1/image/assets/TEMP/ec3b1979ebd42585e8a43f121a5a2792cd9dc58c', value: '아이스' },
        { icon: 'https://cdn.builder.io/api/v1/image/assets/TEMP/04dabf840c4cf0b87799c6e096929c365ec2909c', value: '80ml' }
      ],
      name: '액티브',
